        ...
        <div className="max-w-screen-lg mx-auto flex justify-between gap-16 sm:flex-row flex-col lg:px-0 px-6">
          <div className="flex flex-col gap-16">
            <div className="flex flex-col gap-3">
              <h1 className="text-white text-4xl font-medium leading-snug">
                Let's create a new <br /> obsession with us!
              </h1>
              <p className="text-[#D9D9D9]">
                Contact us to chat and collaborate with us!
              </p>
            </div>
            {/* <div className='flex flex-col gap-3'>
          ...
          <div className="flex flex-col gap-16">
            ...
            <p className="text-lg text-[#D9D9D9]">
              Jl. Sutawijaya, No.89, Sumberrejo, <br /> Kec.Banyuwangi, Kab.
              Banyuwangi
            </p>
            <div className="flex gap-3 text-white">
              <div
                className="bg-[#1A2756] p-3 rounded-full cursor-pointer"
                onClick={() => {
