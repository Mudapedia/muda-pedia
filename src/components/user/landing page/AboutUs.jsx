...
const AboutUs = () => {
  return (
    <section
      id="tentang-kami"
      className="bg-[#F5F5F5] sm:grid sm:grid-cols-2 max-w-screen-lg mx-auto gap-9 p-9 rounded-lg scroll-mt-[8vh]"
    >
      <div className="flex flex-col gap-4">
        <h1 className="text-4xl font-medium  text-[#091232]">
          Ayo Kembangkan Bisnismu Bersama kami!
        </h1>
        <h2 className="text-lg sm:text-xl text-[#66676A] font-medium">
      ...
      <div className="text-[#66676A] flex flex-col gap-5">
        <p>
          ...
          menuju peluang yang tak terbatas, dan kami hadir sebagai solusi yang
          cerdas dan terpercaya untuk membantu Anda mengembangkan bisnis dalam
          dunia yang terus berubah. Sebagai perusahaan inovatif, kami menawarkan
