...
const Faq = () => {
  return (
    <div className='max-w-screen-md w-full mx-auto flex flex-col justify-between gap-16 items-center lg:px-0 px-6 scroll-mt-[10vh]' id='faq'>
      ...
      <div className='w-full'>
        <Accordion className='w-full' defaultExpandedKeys={["apa"]}>
          ...
          <AccordionItem key="pavo" aria-label="pavocoin" indicator={<Plus />} title="Apa itu PavoCoin?" className='font-medium'>
            <p className='text-[#66676A] font-normal text-lg'>Pavo Official adalah perusahaan teknologi berpikiran maju yang berdedikasi untuk memajukan aset digital dan industri blockchain. PavoCoin adalah produk andalan kami, yang dirancang untuk merevolusi cara orang terlibat dengan mata uang digital dan NFT (Non-Fungible Tokens).</p>
            <p className='mt-8 text-[#66676A] font-normal text-lg pb-3'></p>
          </AccordionItem>
          <AccordionItem key="market" aria-label="marketpavo" indicator={<Plus />} title="Apa itu Maketplace NFT Pavo" className='font-medium'>
            <p className='text-[#66676A] font-normal text-lg'>Pasar NFT untuk PavoCoin di jaringan Solana. Proyek ini juga menggunakan nama koin PavoCoin untuk menjual dan membeli NFT di PavoCoin.</p>
            <p className='mt-8 text-[#66676A] font-normal text-lg pb-3'></p>
          </AccordionItem>
        </Accordion>
      </div>
